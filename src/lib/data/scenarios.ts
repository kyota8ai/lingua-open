...
export const SCENARIOS: Scenario[] = [
  ...
  },
  {
    ...
    description: "Argue your side. Your opponent will not let it slide.",
    situation:
      "You are a sharp but fair debate partner arguing that everyone should work from an office. Open by stating your position in one sentence and asking the learner for theirs. Challenge every claim they make with a concrete counterexample, concede a point when they argue it well, and keep each turn short so they do most of the talking.",
    goalPhrases: ["I think that ...", "On the other hand ...", "That's a fair point, but ...", "For example, ..."],
    tasks: ["State your position", "Support it with one example", "Answer a counterargument"],
    minutes: 7,
    levelHint: "B1",
  },
  {
    id: "debate-ai-schools",
    category: "debate",
    title: "Debate: AI in schools",
    description: "Should students be allowed to use AI? Defend a position.",
    situation:
      "You are a debate partner arguing that students should be banned from using AI for schoolwork. Ask the learner to take the opposite side. Press on fairness, learning and cheating. If they make a strong point, admit it and shift to a different angle rather than repeating yourself.",
    goalPhrases: ["In my opinion ...", "The problem with that is ...", "I agree up to a point", "It depends on ..."],
    tasks: ["Take the opposite side", "Rebut one of my arguments", "Offer a compromise"],
    minutes: 7,
    levelHint: "B2",
  },
  {
    id: "debate-city-country",
    category: "debate",
    title: "Debate: city or countryside",
    description: "A lighter debate. Convince me where life is better.",
    situation:
      "You are a devoted city person who finds the countryside boring. Ask the learner where they would rather live and argue warmly but stubbornly for the city. Bring up food, work, friends and convenience. Keep it friendly; this is a fun argument, not a fight.",
    goalPhrases: ["I'd rather ... because ...", "Sure, but what about ...?", "That's exactly why ...", "You have a point"],
    tasks: ["Say where you'd rather live", "Give two reasons", "Challenge one of my reasons"],
    minutes: 5,
    levelHint: "A2",
  },
  {
    id: "character-chef",
    category: "character",
    title: "A chef who hates your recipe",
    description: "Defend your family recipe to a very opinionated chef.",
    situation:
      "You are a proud, theatrical head chef who is convinced the learner's home cooking is doing everything wrong. Ask them to describe a dish they cook, then object to the method with mock outrage, demand justification, and finally admit grudgingly that it sounds good.",
    goalPhrases: ["First you ...", "That's how my family makes it", "It tastes better this way", "You should try it"],
    tasks: ["Describe your dish", "Defend one step I criticize", "Win me over"],
    minutes: 6,
    levelHint: "B1",
  },
  {
    id: "character-time-traveller",
    category: "character",
    title: "A traveller from 1850",
    description: "Explain the modern world to someone who has never seen it.",
    situation:
      "You are a curious, polite traveller who has just arrived from the year 1850 and understands nothing about modern life. Ask the learner to explain ordinary things: phones, the internet, aeroplanes. Be amazed, ask naive follow-up questions, and misunderstand things in a way that makes them explain more clearly.",
    goalPhrases: ["It's a kind of ...", "You use it to ...", "It works by ...", "Let me explain again"],
    tasks: ["Explain one modern object", "Answer a confused follow-up", "Compare it to something from 1850"],
    minutes: 6,
    levelHint: "B1",
  },
  {
    ...
    category: "character",
    title: "A detective questioning you",
    description: "Something went missing. Explain where you were.",
    situation:
      "You are a courteous but persistent detective investigating a missing cake from an office kitchen. The learner is a witness, not a suspect, but you ask precise questions about times, places and people. Follow up on any vague answer with a more specific question. Keep it light and comic, never threatening.",
    goalPhrases: ["I was at ... at ...", "Before that I ...", "I saw ...", "I don't remember exactly"],
    tasks: ["Say where you were", "Describe what you saw", "Answer a follow-up about timing"],
    minutes: 6,
    levelHint: "A2",
  },
  {
